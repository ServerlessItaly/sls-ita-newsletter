...
import {SlsItaNewsletterStack} from '../lib/sls-ita-newsletter-stack';

const app = new cdk.App();

new SlsItaNewsletterStack(app, 'SlsItaNewsletterStack', {
    fromEmailAddress: 'henrikfricke@web.de',
    confirmationLinkExpirationTime: cdk.Duration.days(1),
    redirectUrls: {
